        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
            <div>
                <h1 class="text-3xl font-extrabold text-white tracking-tight">
                    Welcome back, <span class="text-emerald-400">{{ Auth::user()->name ?? 'User' }}</span> 👋
                </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            ...
            <div class="bg-gray-800 hover:bg-gray-750 rounded-xl shadow-lg p-6 flex items-center gap-4 transition duration-150">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">{{ $myListingsCount ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="bg-gray-800 hover:bg-gray-750 rounded-xl shadow-lg p-6 flex items-center gap-4 transition duration-150">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">{{ $messagesCount ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="bg-gray-800 hover:bg-gray-750 rounded-xl shadow-lg p-6 flex items-center gap-4 transition duration-150">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">{{ $favoritesCount ?? 0 }}</p>
                </div>
            </div>
        </div>
