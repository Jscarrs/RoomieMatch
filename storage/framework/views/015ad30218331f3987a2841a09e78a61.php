        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white bg-success shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><?php echo e($myListingsCount ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white bg-info shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><?php echo e($messagesCount ?? 0); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card text-white bg-primary shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">Welcome back, <?php echo e(Auth::user()->name ?? 'User'); ?>!</p>
                </div>
            </div>
        </div>
    </div>
